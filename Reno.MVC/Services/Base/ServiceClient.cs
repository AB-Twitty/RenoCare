...
namespace Reno.MVC.Services.Base
{
    ...
    public partial class PatientListItemDto
    {
        ...
        [Newtonsoft.Json.JsonProperty("diabetes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Diabetes { get; set; }

        [Newtonsoft.Json.JsonProperty("hypertension", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Hypertension { get; set; }

        [Newtonsoft.Json.JsonProperty("reportsCount", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
